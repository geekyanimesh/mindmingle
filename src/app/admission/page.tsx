...
const documents = [
  { num: "01", text: "Birth certificate of the child.", icon: "📄" },
  {
    num: "02",
    ...
    <>
      ...
      <section className="relative h-60 md:h-72 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-16 max-w-7xl mx-auto">
          ...
          <h1
            className="sec-title text-5xl md:text-6xl text-white tracking-tight"
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            {programs.map((p) => (
              ...
              >
                ...
                <div>
                  <p className="sec-title text-lg text-slate-800 leading-none">{p.name}</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {documents.map((doc, i) => (
              ...
              >
                <span
                  className="absolute -top-3 -right-1 text-8xl font-black opacity-5 select-none sec-title"
                ...
                <div
                  className="text-xs font-black uppercase tracking-widest mb-2 sec-title"
                  style={{ color: ["#ff5252", "#00bcd4", "#673ab7"][i] }}
                >
                  Document {doc.num}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        ...
        <div className="bg-gradient-to-r from-[#00bcd4]/10 to-[#673ab7]/5 rounded-3xl p-6 mb-8 border border-[#00bcd4]/20">
          <p className="body-text text-slate-700 text-base leading-relaxed font-medium">
            <span className="text-[#673ab7] font-bold">The KiDS Square Day Care</span> program is a secure heaven
            for working parents to leave their children in while they are at work. It is a{" "}
      ...
      <section className="bg-gradient-to-r from-[#673ab7] to-[#00bcd4] py-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          <h2 className="sec-title text-4xl md:text-5xl text-white mb-4">Ready to Join Our Family?</h2>
